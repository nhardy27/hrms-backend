# Generated by Django 5.1 on 2026-02-10 04:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attendance_status', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='attendances', to='api.attendancestatus')),
            ],
            options={
                'ordering': ['-date'],
